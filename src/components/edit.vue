                                ...
                                <div class="postform text-left">
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="subject" name="subject" ref="subject" :value="this.$route.query.item.subject">
                                        </div>

                                        <div class="form-group">
                                            <label for="content">内容：</label>
                                            <wang-editor :catchData="catchData"  id="account--editor" ref="editor" :popdata="this.$route.query.item.content"></wang-editor>
                                        </div>
                                        ...
                                        <button type="button" class="btn btn-info" @click="updatePost">提交</button>
                                    </form>
    ...
    methods:{
        ...
        updatePost(){
            ...
            if(this.$refs.authcodeValue.value == this.authcode){
                ...
                _this.axios.post('http://localhost/biyesheji/updatepost.php',params).then(function(res){
                    if(res.data.is_success === true){
                        _this.show.message = '更新成功！'
                        _this.show.type = 'success'
                    }
                    if(res.data.is_success === false){
                        _this.show.message = '更新失败，请重试！'
